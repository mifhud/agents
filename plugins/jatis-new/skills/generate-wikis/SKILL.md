...
**Index Templates:**
- **wikis/feature.md** → Use [templates/feature-index.md](templates/feature-index.md)
- **wikis/uat.md** → Use [templates/uat-index.md](templates/uat-index.md)  
- **wikis/changelog.md** → Use [templates/changelog-index.md](templates/changelog-index.md)
- **wikis/_sidebar.md** → Use [templates/sidebar.md](templates/sidebar.md)

#### Process
1. Scan all files in respective folders (feature/*.md, uat/*.md, changelog/*.md)
2. Extract entry name from filename (without extension)
3. For **Feature index**: Check if `{feature-name}-flowchart.md` exists
   - Jika ada → include field **Flowchart**
   - Jika tidak ada → skip field Flowchart
4. Generate index using the template format:
   - **Feature**: Name, Deskripsi, Link, Flowchart (optional)
   - **UAT**: Name, Deskripsi, Link
   - **Changelog**: Version, Tanggal Release, Deskripsi, Link
5. Save to root wikis/ folder
6. **Generate _sidebar.md** → Use [templates/sidebar.md](templates/sidebar.md)
   - Save to `wikis/_sidebar.md` in root folder
   - Copy content exactly from sidebar template
