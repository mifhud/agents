...
- **Language** - Provide the explanation in Indonesian, but for technical terms, do not translate them.

---

## Single-File Template: `{feature-name}.md`
```markdown
# {Feature Name}
...
### Details
- **Who uses**: {User types}
- **Connects to**: [Process 3]
- **Started from**: [Process 1]
...
{Continue with same step structure...}

---

## Process 3: {User-Friendly Process Title}

{Continue pattern for all processes...}
...
1. **Start with overview** - Give the big picture first
2. **Order processes logically** - Follow typical user journey
3. **Use clear headings** - Make it scannable
4. **Show connections** - Help readers understand relationships
5. **End with reference** - Provide quick lookup sections
6. If there are multiple processes to document, create a separate file for each and name it after the process