...
## description:
Convert a Claude Code plan file into beads epic + tasks for cross-session tracking. Must use hierarchical IDs for epics and tasks.
...
8. Always use hierarchical IDs for epics and tasks:
    ```
    bd-a3f8 (Epic)
    bd-a3f8.1 (Task)
